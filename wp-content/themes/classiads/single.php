						...
						<div class="author-detail-right clearfix">
							...
							?>
								<span class="ad-detail-info">
					    			<span class="ad-details"><i class="fa fa-map-marker"></i>Address:<?php echo $wpcrown_author_address; ?></span>
								</span>
							<?php
								} 		
							?>
							...
							?>
								<span class="ad-detail-info"> 
				    				<span class="ad-details"><i class="fa fa-phone"></i>Call:<?php echo $wpcrown_author_phone; ?></span>
								</span>
							<?php
								} 		
							?>
