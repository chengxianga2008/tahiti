 ...
 * @subpackage simple_html_1_11_dom
 */
...
function simple_html_1_11_file_get_html($url, $use_include_path = false, $context=null, $offset = -1, $maxLen=-1, $lowercase = true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT)
{
    // We DO force the tags to be terminated.
    $dom = new simple_html_1_11_dom(null, $lowercase, $forceTagsClosed, $target_charset, $defaultBRText);
...
function simple_html_1_11_str_get_html($str, $lowercase=true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT)
{
    $dom = new simple_html_1_11_dom(null, $lowercase, $forceTagsClosed, $target_charset, $defaultBRText);
    if (empty($str))
    {
...
// dump html dom tree
function simple_html_1_11_dump_html_tree($node, $show_attr=true, $deep=0)
{
    $node->dump($node);
}
 ...
 * @package PlaceLocalInclude
 */
class simple_html_1_11_dom_node {
...
class simple_html_1_11_dom {
    ...
    function load_file() {
        ...
        // Per the simple_html_1_11_dom repositiry this is a planned upgrade to the codebase.
    ...
    protected function prepare($str, $lowercase=true, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT) {
        ...
        $this->root = new simple_html_1_11_dom_node($this);
        $this->root->tag = 'root';
    ...
    protected function parse() {
        ...
        // text
        $node = new simple_html_1_11_dom_node($this);
        ++$this->cursor;
    ...
    protected function read_tag() {
        ...
        if ($this->char==='/') {
            $this->char = (++$this->pos<$this->size) ? $this->doc[$this->pos] : null; // next
            // This represetns the change in the simple_html_1_11_dom trunk from revision 180 to 181.
